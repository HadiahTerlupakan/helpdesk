...
const config = {
  ...
  // **CATATAN PENTING:** Data admin akan dimuat dari Firebase saat server pertama kali dimulai
  // jika path '/admins' di Firebase kosong. Setelah admin ditambahkan/diubah melalui fitur
  // Super Admin di aplikasi, Firebase akan menjadi sumber kebenaran. Mengedit file ini
  // TIDAK akan berpengaruh lagi setelah admin tersimpan di Firebase, kecuali jika data Firebase dihapus.
  // Password di sini dan di Firebase sebaiknya di-HASH (misal: menggunakan library bcrypt)
  ...
  // Pastikan username ini ada dalam daftar 'admins' di atas ATAU di data admin di Firebase
